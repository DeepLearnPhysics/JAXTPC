...
Usage:
    python3 closure_analysis_muon/run_optimization.py A          # single run
    python3 closure_analysis_muon/run_optimization.py A B C D    # all four
    python3 closure_analysis_muon/run_optimization.py A --steps 800 --lr 0.02
"""
...
# Named initial guesses (perturbations from truth)
INIT_CONFIGS = {
...
def main():
    ...
    loss_and_grad, truth_start, truth_end = setup()
