...
Supports loss types: MSE, Blur MSE, Sobolev Sum, Sobolev Geomean,
Sobolev Geomean Log1p.

Run from project root:
    python3 closure/muon/surfaces.py --loss mse
    python3 closure/muon/surfaces.py --loss blur
    python3 closure/muon/surfaces.py --loss all
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=['mse', 'blur', 'sobolev_sum', 'sobolev_geomean',
                 'sobolev_geomean_log1p', 'all'],
        help='Which loss to run (default: all)',
    )
    args = parser.parse_args()
    if args.loss == 'all':
        main(['mse', 'blur', 'sobolev_sum', 'sobolev_geomean',
